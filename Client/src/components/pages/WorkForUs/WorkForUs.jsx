    ...
    <>
      ...
      <div className={`${styles.container1}`}>
        ...
        <p className={`my-4 w-75`}>
          ...
          partner in Turkey? <br /> - Does your club, organization, university
          or company organize group tours to Turkey? <br /> - Do you have a
          group that has a special interest in some places or activities in
          Turkey? <br /> - Would you like to provide us your Turkey tour idea so
          that we can work out a unique tour project for you? <br /> - Why not
          make Turkey Magic Travel your best travel support in Turkey? <br /> <br />
          Turkey is one of the fastest-growing tourism markets in the world. Get
          ...
          travel in Turkey. Turkey Magic Travel has been in the travel industry
          in Turkey for almost 30 years. Our knowledge, together with the many
          relationships that we have developed over that period will ensure that
          Turkey Magic Travel provides all that you want.
        </p>
        ...
        <p className={`my-4 w-75`}>
          ...
          supplier and a booking office in Turkey for you and offer you the net
          price for all travel products in Turkey. You market and sell the
        ...
        <p className={`my-4 w-75`}>
          ...
          prices. <br />
          We will have a local contact in Turkey to provide backup in an
          emergency or just a familiar voice at the end of a phone while your
          customers are in Turkey. <br />
